...
print(f"Ennek a polygonnak {your_polygon.sides} oldala van és a színe {your_polygon.color} cm")
print(id(your_polygon))

third_polygon = Polygon(5)
print(f"Ennek a polygonnak {third_polygon.sides} oldala van, a színe {third_polygon.color} és oldalainak szélessége {third_polygon.szelesseg}")